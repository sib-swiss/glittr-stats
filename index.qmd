...
Number of SIB courses with repository-like materials not yet available on Glittr: `r nrow(missing_courses_on_glittr)`

```{r}
#| label: tbl-sib-courses-missing-on-glittr
#| tbl-cap: SIB training courses with course-material repositories not yet available on Glittr
...
Number of TeSS materials with GitHub/GitLab resources not yet available on Glittr: `r nrow(tess_missing_on_glittr)`

```{r}
#| label: tbl-tess-materials-missing-on-glittr
#| tbl-cap: TeSS materials with GitHub/GitLab resources not yet available on Glittr
